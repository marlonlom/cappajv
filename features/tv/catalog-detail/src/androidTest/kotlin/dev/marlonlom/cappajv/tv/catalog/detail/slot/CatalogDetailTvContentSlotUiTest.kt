...
internal class CatalogDetailTvContentSlotUiTest {
  ...
  fun shouldDisplayContentThenClickLikeButton() {
    with(composeTestRule) {
      ...
      onNodeWithText(catalogItem.category).assertIsDisplayed()
      onNodeWithText(catalogItem.title).assertIsDisplayed()
      onNodeWithText(catalogItem.detail).assertIsDisplayed()
